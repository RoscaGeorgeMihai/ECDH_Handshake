...
public:
	...
	bool load_ECC_private_key();
	bool load_RSA_private_key();
	bool load_RSA_public_key();
	bool load_ECC_key_mac(unsigned char** der_mac, size_t* der_len);
	bool load_RSA_key_mac(unsigned char** der_mac, size_t* der_len);

	bool verify_public_key_mac(string key_filename, unsigned char* mac_value, size_t mac_len);
	...
	bool save_ECC_private_key();
	bool save_RSA_private_key();
